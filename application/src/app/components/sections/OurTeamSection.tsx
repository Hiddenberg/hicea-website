...
function TeamMemberCard({
   ...
   return (
      <div className="flex flex-col items-center gap-2 p-4 rounded-lg w-[85dvw] snap-center shrink-0">
         ...
         />
         <div className="mb-2">
            <h3 className="font-semibold text-hicea-purple text-xl text-center">
               {name}
            </h3>
            <p className="font-semibold text-hicea-pink text-xl text-center">
               {role}
            </p>
         </div>
         <a
...
export default function OurTeamSection() {
   return (
      <div className="p-6 md:px-10 lg:px-16 w-full">
         <TextLineIcon />
         <h2 className="font-semibold text-hicea-purple text-3xl">
