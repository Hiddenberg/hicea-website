...
export default function FooterSection() {
   ...
   return (
      <div className="flex md:flex-row flex-col justify-between items-center gap-4 md:gap-0 bg-hicea-dark-purple px-4 md:px-10 py-4 md:py-6 w-full">
         ...
         >
            <div className="flex justify-center items-center bg-hicea-pink rounded-full size-10 md:size-14 shrink-0">
               <svg
                  width="20"
                  height="20"
                  viewBox="0 0 24 24"
         ...
         {/* Copyright Section */}
         <p className="order-3 md:order-2 text-white text-xs md:text-base text-center">
            Copyrights © 2026 All Rights Reserved by Hicea
         </p>
