...
const aboutUsItems: AboutUsItemProps[] = [
   ...
   },
   {
      ...
      description: "Ser el referente nacional en salud ginecológica, reconocido por un modelo de atención humano, cercano e innovador que prioriza la confianza y el bienestar de cada mujer. Buscamos expandir nuestro alcance para brindar acompañamiento integral y soluciones accesibles, eliminando barreras geográficas y sociales, y asegurando que toda mujer, sin importar dónde se encuentre, tenga acceso a atención digna, profesional y de calidad.",
      iconURL: "/assets/VISION.svg"
   },
   {
      title: "Nuestros valores",
      description: "Nos guiamos por la accesibilidad, la calidad y el compromiso para brindar atención responsable y cercana. Creemos en la prevención como base del bienestar femenino y actuamos con empatía, respeto y sensibilidad en cada consulta. Garantizamos la confidencialidad, creando un espacio seguro donde cada mujer se sienta escuchada, valorada y protegida.",
