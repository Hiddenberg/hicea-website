...
const otherServices: OtherServiceCardProps[] = [
   {
      ...
      "description": "La planificación familiar es un aspecto esencial de la salud reproductiva y el bienestar general de las personas y las familias. Permite a las parejas decidir el número de hijos que desean tener y el momento adecuado para tenerlos, contribuyendo así a mejorar la calidad de vida y la salud de la madre y el niño. Existen diversos métodos de planificación familiar que se pueden agrupar en métodos naturales, métodos de barrera, métodos hormonales, dispositivos intrauterinos, métodos permanentes y otros métodos modernos.",
